...
// Return the pitch (rotation around the y-axis) in Radians using Game Rotation Vector
float BNO08x::getGamePitch()
{
	float dqw = getGameQuatReal();
	float dqx = getGameQuatI();
	float dqy = getGameQuatJ();
	float dqz = getGameQuatK();
...
// Return the yaw / heading (rotation around the z-axis) in Radians using Game Rotation Vector
float BNO08x::getGameYaw()
{
	float dqw = getGameQuatReal();
	float dqx = getGameQuatI();
	float dqy = getGameQuatJ();
