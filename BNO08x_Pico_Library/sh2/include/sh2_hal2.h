...
#define SH2_HAL_MAX_TRANSFER_OUT_2 (256)
#define SH2_HAL_MAX_PAYLOAD_OUT_2  (256)
...
#define SH2_HAL_MAX_TRANSFER_IN_2  (384)
#define SH2_HAL_MAX_PAYLOAD_IN_2   (384)

// This needs to be a power of 2, greater than max of the above.
#define SH2_HAL_DMA_SIZE_2 (512)

typedef struct sh2_Hal_s_2 sh2_Hal_t_2;
...
struct sh2_Hal_s_2 {
    ...
    int (*read)(sh2_Hal_t_2 *self, uint8_t *pBuffer, unsigned len, uint32_t *t_us);
